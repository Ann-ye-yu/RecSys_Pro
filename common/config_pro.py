...
RECEIVERS = ['1051532098@qq.com', "xiaotao.peng@aminer.cn"]  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
...
# INPUT_LOG_DATA = "E:/input_data/input_log_data.json"
INPUT_LOG_DATA_BASE =  "/data/cache/aminer/meta/active_user"
...
LOGGING_FILE_PATH="/data/weblog/rms_recall.log"
