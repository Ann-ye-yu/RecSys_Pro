...
# dev
HINDEX_PAPERS_FILE = '/data/cache/aminer/pub.json'
...
FOCUS_SCHOLAR_RECALL_PATH_BASE = "/data/cache/aminer/meta/follow_recall/followed_scholar_recall"
if os.path.exists(f'/data/cache/aminer/meta/latest_paper/{YESTERDAY_TAG}-latest_paper_pool.json'):
    GLOBAL_NEWEST_POOL = f'/data/cache/aminer/meta/latest_paper/{YESTERDAY_TAG}-latest_paper_pool.json'
else:
...
LOG_SAVE_DAYS = 3
LOG_SAVE_PATH = "/data/cache/aminer/meta/follow_recall/"
